...
export default {
  getsearchForGroup: (flickerApiKey, searchParam) => (`https://www.flickr.com/services/rest/?method=flickr.groups.search&api_key=${flickerApiKey}&text=${searchParam}&per_page=500&format=json&nojsoncallback=1`),
